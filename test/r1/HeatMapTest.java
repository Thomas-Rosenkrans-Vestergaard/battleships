...
public class HeatMapTest {
    ...
    public void testConstructorTwoArgs() throws Exception {
        ...
        assertEquals(0, map.get(Position.at(0, 0)));
        map.put(Position.at(0, 0));
        assertEquals(1, map.get(Position.at(0, 0)));
    }
    ...
    public void testReset() throws Exception {
        ...
        assertEquals(5, map.get(Position.at(0, 0)));
        assertEquals(5, map.get(Position.at(0, 1)));
        assertEquals(5, map.get(Position.at(1, 0)));
        assertEquals(5, map.get(Position.at(1, 1)));

        map.reset();

        assertEquals(0, map.get(Position.at(0, 0)));
        assertEquals(0, map.get(Position.at(0, 1)));
        assertEquals(0, map.get(Position.at(1, 0)));
        assertEquals(0, map.get(Position.at(1, 1)));
    }
    ...
    public void testResetTo() throws Exception {
        ...
        assertEquals(10, map.get(Position.at(0, 0)));
        assertEquals(10, map.get(Position.at(0, 1)));
        assertEquals(10, map.get(Position.at(1, 0)));
        assertEquals(10, map.get(Position.at(1, 1)));
    }
}
